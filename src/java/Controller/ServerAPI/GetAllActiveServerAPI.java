 ...
 * @author hoan
 */
public class GetAllActiveServerAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Server> servers = ServerDB.getActiveServers();
        ...
        if (servers != null) {
            ...
            JsonObject.addProperty("message", "No active servers found!");
